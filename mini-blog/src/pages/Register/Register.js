    ...
    <div className={styles.register}>
        ...
        <form onSubmit={handleSubmit}>
            ...
            <label>
                ...
                <input type='password' name='confirmPassword' required placeholder='please, confirm your password.' value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)}/>
            </label>
